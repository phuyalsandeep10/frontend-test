...
export function AgenChatHistoryCard({
  ...
  return (
    <Card className="w-full max-w-full">
      <CardHeader className="inline-flex items-center gap-x-[17px] gap-y-[14px]">
        {headericon && (
              ...
              {[...Array(5)].map((_, i) => {
                return (
                  <span key={i}>
                    <Icons.ri_star_fill
                      className={
                        i < 3 ? 'text-warning-prominent' : 'text-gray-light'
                      }
                    />
                  </span>
                );
            ...
            <div className="flex w-full gap-2">
              ...
              <div className="flex w-full flex-col gap-y-[14px]">
                <div className="flex w-full justify-between">
                  ...
                  <span className="text-theme-text-primary text-xs leading-[17px] font-normal">
                    04:15 PM
                  </span>
                </div>
                ...
                <div className="flex gap-2 text-xs leading-4 font-semibold">
                  <Badge className="bg-error-light text-alert-prominent">
                    Unresolved
                  </Badge>
                  <Badge
                    variant="outline"
                  ...
                  >
                    <div className="bg-secondary-hover flex h-[20px] w-[20px] items-center justify-center rounded-[50px] px-[2px] py-[2px]">
                      {' '}
